# context-compiler-bootstrap (Gemini CLI)
...
A blank wiki can be scaffolded with `scripts/create-context-compiler.sh <target-dir>` (the installer; verified by `scripts/verify-create-context-compiler.sh`).
